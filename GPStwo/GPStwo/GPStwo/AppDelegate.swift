...
class AppDelegate: UIResponder, UIApplicationDelegate ,CLLocationManagerDelegate{
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyA7hwq_2F3Q40MZkuGnc5_do_WXh2oETVY")
        GMSServices.provideAPIKey("AIzaSyA7hwq_2F3Q40MZkuGnc5_do_WXh2oETVY")
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "GPStwo")
    ...
    func doBackgroundTask() {
        ...
        DispatchQueue.main.async {
            ...
            RunLoop.current.add(self.bgtimer, forMode: RunLoop.Mode.tracking)
            RunLoop.current.run()
